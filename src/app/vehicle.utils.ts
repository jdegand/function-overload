...
export function createVehicle(type: 'boat', fuel: Fuel | undefined, capacity: number, isPublicTransport?: boolean): Boat
export function createVehicle(type: 'bus', fuel: Fuel | undefined, capacity: number, isPublicTransport: boolean): Bus
export function createVehicle(type: VehicleType, fuel?: Fuel, capacity?: number, isPublicTransport?: boolean): Vehicle {
  switch (type) {
    case 'bicycle':
      return { type };
    case 'car':
